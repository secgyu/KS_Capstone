...
import { Pressable, StyleSheet, Text, View, PressableProps, ScrollView } from "react-native";
...
const MarkerSelector = ({ markerColor, score = 5, onPressMarker }: MarkerSelectorProps) => {
