...
import FeedFavoriteNavigator from '@/screens/feed/FeedFavoriteNavigator';
import FeedHomeHeaderLeft, {
  FeedHomeHeaderLeftProps,
} from '@/components/feed/FeedHomeHeaderLeft';
...
export const TabNavigator = () => (
  <Tab.Navigator
    ...
    <Tab.Screen
      ...
      options={({route}) => ({
        ...
        tabBarStyle: (tabRoute => {
          const routeName =
            getFocusedRouteNameFromRoute(tabRoute) ?? feedNavigations.FEED_HOME;
    ...
    <Tab.Screen
      ...
      component={FeedFavoriteNavigator}
      options={({navigation}) => ({
        headerTitle: '즐겨찾기',
        headerLeft: () =>
          FeedHomeHeaderLeft(navigation as unknown as FeedHomeHeaderLeftProps),
      })}
    />
    <Tab.Screen
